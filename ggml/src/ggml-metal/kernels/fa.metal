...
template [[host_name("kernel_flash_attn_ext_kv_iq4_nl_f16")]] kernel kernel_flash_attn_ext_kv_f16_t kernel_flash_attn_ext_kv_f16<block_iq4_nl, 32, dequantize_iq4_nl>;
