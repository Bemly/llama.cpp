...
struct llama_model {
    ...
    // Hadamard-folded GGUF weights matched with persistent model tensors
    // holding the activation-side transform. String map filled from GGUF
    // metadata in load_hparams; pointer map filled after buffer allocation.
